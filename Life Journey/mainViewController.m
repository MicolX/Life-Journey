...
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Enable iCloud Drive", nil)
                                                                   message:NSLocalizedString(@"Please enable iCloud Drive to backup your journals on iCloud", nil)
