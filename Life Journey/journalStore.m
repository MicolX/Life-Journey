...
- (instancetype)initPrivate
{
    if (self = [super init]) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(verifyShallBegin) name:@"VerifyShallBegin" object:nil];
...
{
    NSLog(@"create query, download journals begin");
    if (sync) {
